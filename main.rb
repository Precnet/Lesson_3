...
class UserInterface
  ...
  def create_default_menu
    ...
    @ui.create_menu_item('Create new cargo train', Proc.new { |number=nil| user_action.create_cargo_train number})
    @ui.create_menu_item('Show existing trains', Proc.new { user_action.show_existing_trains })
